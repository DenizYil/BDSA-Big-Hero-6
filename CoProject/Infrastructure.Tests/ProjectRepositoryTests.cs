...
public class ProjectRepositoryTests : DefaultTests
{
    ...
    public async void Create_Project_Given_ProjectCreateDTO_Returns_ProjectDetailsDTO()
    {
        ...
        var expected = new ProjectDetailsDTO(2, "CoolProject", "Description for the Coolest Project", new UserDetailsDTO("1", "Myself", "me@me.dk"), State.Hidden, actual.Created, new List<string>(), new List<UserDetailsDTO>())
        {
            Min = 1,
            Max = 4,
        };
    ...
    {
        //Arrange
        var expected = new ProjectDetailsDTO(1, "Karl", "yep hehe smiley", new UserDetailsDTO("1", "Myself", "me@me.dk"), State.Open, now, new List<string>(), new List<UserDetailsDTO>());
    ...
    public async void ReadAll_Given_Multiple_existing_Projects_Returning_All_Projects()
    {
        ...
        {
            new(1, "Karl", "yep hehe smiley", new UserDetailsDTO("1", "Myself", "me@me.dk"), State.Open, now, new List<string>(), new List<UserDetailsDTO>()),
            new(2, "Phillip", "This is another cool description", new UserDetailsDTO("2", "Yourself", "you@you.dk"), State.Open, now, new List<string>(),
